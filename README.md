...
API REST para el sistema de gestión de services (panel `/dashboard` y `/recontacto` en el frontend).
...
npx prisma generate
npx prisma db push         # sincroniza el schema con la base (no borra datos)
